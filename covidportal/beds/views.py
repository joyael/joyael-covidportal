...
def index(request):
    ...
    type_of_hospital_list = str(type(hospital_list))
    ...
    context = {
        ...
        'hospitals': hospitals,
        'type_of_hospital_list': type_of_hospital_list
    }
...
def hospital_manage(request):
    return render(request, 'beds/hospital_manage.html')

def hospital_manage_done(request):
    return render(request, 'beds/hospital_manage_done.html')
